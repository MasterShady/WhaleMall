    ...
    /// 创建城市选择器
     lazy var pickerView: UIPickerView = {
       let pickerView = UIPickerView(frame: CGRect(x: 0, y:
            SCALE_HEIGTHS(value: 55), width:SCREEN_WIDTH , height: SCALE_HEIGTHS(value: 215)))
//        let pickerView = UIPickerView()
        pickerView.delegate = self
        pickerView.dataSource = self
        pickerView.backgroundColor = UIColor(hexString: "#FFFFFF")
        return pickerView
    }()
    
    /// 创建容器
     lazy var containView: UIView = {
        let containView = UIView(frame: CGRect(x: 0, y: SCREEN_HEIGHT, width:SCREEN_WIDTH , height: SCALE_HEIGTHS(value: 270)))
    ...
    /// 创建容器中的titleToolBar
     lazy var titleToolBar: UIView = {
        let titleToolBar = UIView(frame: CGRect(x: 0, y: 0, width: SCREEN_WIDTH, height: SCALE_HEIGTHS(value: 55)))
    ...
    /// 创建确定按钮
     lazy var sureButton: UIButton = {
        let sureButton = UIButton(frame: CGRect(x: SCREEN_WIDTH - SCALE_WIDTHS(value: 65), y: 0, width: SCALE_WIDTHS(value: 65), height: SCALE_HEIGTHS(value: 55)))
//        let sureButton = UIButton()
    ...
    /// 创建取消按钮
     lazy var cancleButton: UIButton = {
        let cancleButton = UIButton(frame: CGRect(x: 0, y: 0, width: SCALE_WIDTHS(value: 65), height: SCALE_HEIGTHS(value: 55)))
    ...
    /// 显示view
     func showView() {
        ...
        UIView.animate(withDuration: 0.3) {
            ...
            self.containView.kl_bottom = SCREEN_HEIGHT
        }
    }
    ...
    /// 隐藏View
     func hideView() {
        UIView.animate(withDuration: 0.3, animations: {
            ...
            self.containView.kl_y =  SCREEN_HEIGHT
        }) { (finish) in
...
extension KLCityPickerView: UIPickerViewDataSource, UIPickerViewDelegate {
    ...
    public func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        if label == nil {
            ...
            label?.textColor = pickerLabelTextCoclor
